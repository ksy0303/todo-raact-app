...
class AddTodo extends React.Component {
    ...
    onButtonClick = () =>  {
        ...
        this.setState({item:{title:""}});   // todo 추가후 입력창 초기화 
    }
            ...
            <Paper style={{margin:16, padding:16}}>
                <Grid container>
                    <Grid xs={11} md={11} item style={{paddingRight:16}}>
                        <TextField placeholder="Add Todo here" fullWidth onChange={this.onInputChange} value={this.state.item.title} onKeyUp={this.enterKeyEventHandler} />
                    </Grid> 
                    <Grid xs={1} md={1} item>
